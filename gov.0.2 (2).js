...
function applyNewStyle(){
    ...
    $('.file-limit-1, .file-limit-2, .file-limit-3, .file-limit-4, .file-limit-5, .file-limit-6, .file-limit-7, .file-limit-8, .file-limit-9, .file-limit-10').each(
        function(){
            ...
            $(this).find('.file-gov-text').text('Select Files: '+fileLimit);
            console.log('Filelimt: '+fileLimit);//console.log('First $this');console.log($(this));
                ...
                function(event) {
                    if (event.type == 'DOMNodeInserted'){
                        ...
                        if(current >= fileLimit){
                            ...
                            console.log($(this))
                            $(this).parent().find('.file-gov-text').text('Select Files: '+(fileLimit-current));
                        }
                    } else {
